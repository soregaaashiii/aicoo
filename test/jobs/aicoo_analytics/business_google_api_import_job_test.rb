  ...
  class BusinessGoogleApiImportJobTest < ActiveJob::TestCase
    ...
    test "marks run successful and updates business metrics" do
      fake_importer_class = Class.new do
        Result = Data.define(:metric_count, :imported_source_labels, :start_date, :end_date, :credential_snapshots)
        ...
        def call
          ...
          Result.new(1, %w[GSC GA4], Date.current - 1.day, Date.current - 1.day, { "gsc" => { "record_id" => 10 } })
        end
      end
