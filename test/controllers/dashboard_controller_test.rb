...
class DashboardControllerTest < ActionDispatch::IntegrationTest
  test "shows AICOO Lab metric summary" do
    ...
    assert_includes response.body, "completed今日"
    assert_includes response.body, "Result未登録 completed"
    assert_includes response.body, "Pending Results"
    assert_includes response.body, "Warning Results"
    assert_includes response.body, "Critical Results"
    assert_includes response.body, "Oldest Delay"
    assert_includes response.body, "Result登録率"
    assert_includes response.body, "平均登録遅延"
    assert_includes response.body, "Learning Loop Completion Rate"
    assert_includes response.body, "Learning Loop Quality"
    ...
    assert_includes response.body, "Discovery Sources"
    ...
    assert_includes response.body, "Explore Signals"
    assert_includes response.body, "Top Explore Signals"
    assert_includes response.body, "Explore Data Hubを見る"
    assert_includes response.body, "今日のImport"
    assert_includes response.body, "今週のImport"
    ...
    assert_includes response.body, "Calibration Effectiveness"
    assert_includes response.body, "Learning Trend"
    assert_includes response.body, "改善提案を見る"
    assert_includes response.body, "今日の確認タスク"
    assert_includes response.body, "Strategic Alignment"
    assert_includes response.body, "Decision補正率"
    assert_includes response.body, "Guardrail warning"
    assert_includes response.body, "最大補正率"
    assert_includes response.body, "Practicality Summary"
    ...
    assert_includes response.body, "Business Health Summary"
    assert_includes response.body, "平均Health Score"
